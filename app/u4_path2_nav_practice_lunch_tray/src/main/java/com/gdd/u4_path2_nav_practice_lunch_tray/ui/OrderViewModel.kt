...
import com.gdd.u4_path2_nav_practice_lunch_tray.model.MenuItem.EntreeItem
import com.gdd.u4_path2_nav_practice_lunch_tray.model.MenuItem.SideDishItem
...
class OrderViewModel : ViewModel() {
    ...
    private fun updateItem(newItem: MenuItem, previousItem: MenuItem?) {
        _uiState.update { currentState ->
            ...
            // subtract previous item price in case an item of the category was already added
